            ...
            <div id="j_idt10" class="ui-outputpanel ui-widget">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tbody>
                                        ...
                                        <div id="j_idt83" class="ui-datalist ui-widget">
                                            <div id="j_idt83_content" class="ui-datalist-content ui-widget-content">
                                                <ul id="j_idt83_list" class="ui-datalist-data">
                                                    ...
                                                    @if ($rectdata->permit_fee_mp!=0.00)
                                                    <li class="ui-datalist-item">
                                                        <div class="ui-grid-row">
                                                            <div class="ui-grid-col-9 left-position hed-bot">Permit Fee</div>
                                                            <div class="ui-grid-col-1 right-position hed-bot"><span
                                                                    class="ui-grid-col-1 right-position">{{$rectdata->permit_fee_mp}}</span>
                                                            </div>
                                                            <div class="ui-grid-col-1 right-position hed-bot">0</div>
                                                            <div class="ui-grid-col-1 right-position hed-bot"><span
                                                                    class="ui-grid-col-1 right-position">{{$rectdata->permit_fee_mp}}</span>
                        ...
                        <tr valign="top">
                            <td colspan="3"><span style="font-weight: bold;">Grand Total : {{$rectdata->total_tax_amount+(($rectdata->service_amount!="") ? $rectdata->service_amount : 0)+(($rectdata->civik_amount!="") ? $rectdata->civik_amount : 0) +(($rectdata->user_service_charge!="") ? $rectdata->user_service_charge : 0) +(($rectdata->cgst!="") ? $rectdata->cgst : 0) +(($rectdata->sgst!="") ? $rectdata->sgst : 0) +(($rectdata->permit_fee_mp!="") ? $rectdata->permit_fee_mp : 0) +$rectdata->return_amont   }}/-</span> </td>
