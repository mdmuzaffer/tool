...
<body onLoad="window.print(), textRepeat()">
    <!-- ,textRepeat()     -->
    <div class="watermark" style="margin-top:90px;">
        <!--            &lt;p style="font-size:100px;"&gt;Sample&lt;/p&gt;--><img id="j_idt10"
            src="{{asset('bangallogo.jpeg?v='.uniqid())}}" alt="" with="00px" height="200px">
    </div>
    <form id="formPrint" name="formPrint" method="get"
        action="{{ route('user.apply.list.wb') }}"
