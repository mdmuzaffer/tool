    ...
    <div>
        ...
        <div class="navbar-collapse navigation-background-nav collapse in" id="navbar" aria-expanded="true"
            ...
            <a href="{{route('user.booking')}}" style="color:#FFFFFF; padding:5px;">Home</a> | <a
                style="color:#FFFFFF; padding:5px;" href="{{route('user.apply.list.wb')}}">Print Vehicle receipt</a> | <a
                    ...
                    <table style="margin:20px 10px;">
                        ...
                        <tr>
                            <td style="padding: 10px;">
                                <a target="_blank"
                                    href="{{ route('user.Recpt.print.wb',['rec'=>$rec->receipt_no]) }}">{{$rec->receipt_no_gen}}</a>
                                    {{-- <a target="_blank"
