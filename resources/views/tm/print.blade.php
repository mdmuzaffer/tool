...
<body onLoad="window.print(), textRepeat()">
    <!-- ,textRepeat()     -->
    <div class="watermark">
    <img id="j_idt10" src="{{asset('tm/Online Tax Payment Portal_files/new_logo.jpeg?v='.uniqid())}}" alt=""> 
    </div>
                    ...
                    <tbody>
                        <tr valign="top">
                             <td width="61%" align="center">
                                ...
                                <div style="font-weight: bold;font-size: 16px;"><b>Border Tax cum Temporary e-Receipt</b></div>
                                <div style="font-weight: bold;font-size: 16px;"><b> One Round Trip Only</b></div>
                            </td>
                            ...
                            <td colspan="3">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td width="15%" class="row-p"><label>Laden Weight.</label></td>
                                        ...
                                        <tr>
                                            ...
                                            <td width="35%" class="row-p">{{strtoupper($rectdata->fitness_validity)}}</td>
                                            <td width="15%" class="row-p"><label>Insurence Validity</label></td>
                                            <td width="35%" class="row-p">{{strtoupper($rectdata->permit_upto)}}</td>
                                        </tr>
                                        <tr>
                                            <td width="15%" class="row-p"><label>PUCC Validity</label></td>
                                            <td width="35%" class="row-p">: {{strtoupper($rectdata->fitdate)}}</td>
                                        ...
                                        <tr>
                                            ...
                                            <td width="35%" class="row-p">: {{strtoupper($rectdata->PermitType)}}</td>
                                        </tr>
                                        <tr>
                                            <td width="15%" colspan="1" class="row-p"></td>
                                            <td width="35%" colspan="3" class="row-p"></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </td>
