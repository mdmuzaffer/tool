    ...
    <body style="" cz-shortcut-listen="true">
        <script>
            ...
            function clickfunction2() {
                ...
                if (d != "") {
                    document.location = "{{route('user.booking.tm')}}?vehicleno=" + d;
                } else {
        ...
        <form id="master_Layout_form" name="master_Layout_form" method="post" action="{{ route('user.booking.create.tm')}}" enctype="application/x-www-form-urlencoded">
            @csrf
            ...
            <div>
                ...
                <div class="navbar-collapse navigation-background-nav collapse in" id="navbar" aria-expanded="true" style="padding: 10px;">
                    <a href="{{route('user.booking.tm')}}" style="color: #ffffff; padding: 5px;">Home</a> | <a style="color: #ffffff; padding: 5px;" href="{{route('user.apply.list.tm')}}">Print Vehicle receipt</a> |
                    ...
                    <a style="color: #ffffff; padding: 5px;" href="{{route('user.logout.tm')}}">Logout</a>
                </div>
                            ...
                            <div class="ui-grid-row">
                                <div class="ui-grid-col-12 top-space center-position contents-Space">
                                    <h1 class="header-main">
                                        ...
                                        <span class="red"> Tamil Nadu</span>
                                    </h1>
                                </div>
                            </div>
                           <!--  <div class="ui-grid-row">
                                ...
                                <div class="ui-grid-col-10">
                                    <div id="uktaxcollection" class="ui-panel ui-widget ui-widget-content ui-corner-all bottom-space" data-widget="widget_uktaxcollection" style="position: relative;">
                                        ...
                                        <div id="uktaxcollection_content" class="ui-panel-content ui-widget-content">
                                            ...
                                            <div class="ui-grid-row">
                                                    ...
                                                    <div id="j_idt321" class="ui-selectonemenu ui-widget ui-state-default ui-corner-all ui-helper-clearfix" style="width: 345px;">
                                                        <div>
                                                            <select class="form-control" data-val="true" data-val-required="Please specify Vehicle Type" id="VehicleType" name="VehicleType" onchange="myFunction()">
                                                                ...
                                                                <option @if($recpt->
                                                                    VehicleType=='CONTRACT CARRIAGE/PASSENGER VEHICLES') selected="selected" @endif value="CONTRACT CARRIAGE/PASSENGER VEHICLES">CONTRACT CARRIAGE/PASSENGER VEHICLES
                                                                </option>
                                                    ...
                                                    <div id="j_idt327" class="ui-selectonemenu ui-widget ui-state-default ui-corner-all ui-helper-clearfix" style="width: 182px;">
                                                        <div>
                                                            <select class="form-control" data-val="true" data-val-required="Please specify Vehicle Class" id="VehicleClass" name="VehicleClass">
                                                                ...
                                                                <option @if($recpt->
                                                                    VehicleClass=='VEHICLE FITTED WITH AIR GENERATOR') selected="selected" @endif value="VEHICLE FITTED WITH AIR GENERATOR">VEHICLE FITTED WITH AIR GENERATOR
                                                                </option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="ui-grid-col-3">
                                                    ...
                                                    <div id="cmb_permit_type" class="ui-selectonemenu ui-widget ui-state-default ui-corner-all ui-helper-clearfix" style="width: 173px;">
                                                        <div>
                                                            <select class="form-control" data-val="true" data-val-required="Please Permit Type" id="PermitType" name="PermitType">
                                                                ...
                                                                <option @if($recpt->PermitType=='CONTRACT CARRIAGE PERMIT') selected="selected" @endif value="CONTRACT CARRIAGE PERMIT">CONTRACT CARRIAGE PERMIT</option>
                                                 ...
                                                 <div class="ui-grid-col-3">
                                                    <label class="field-label resp-label-section"><label id="floor" class="ui-outputlabel ui-widget">Issuing Authority</label> </label>
                                                    <input id="txt_floor_area" name="txt_floor_area" type="text"
                                            ...
                                            <div class="ui-grid-row">
                                                <div class="ui-grid-col-3">
                                                    <label class="field-label resp-label-section">
                                                        <label id="lbl_seat_cap" class="ui-outputlabel ui-widget">
                                                            <span id="demo">Seating Capacity(Exc. Driver)</span>
                                        ...
                                        -->
                                               <!--  <div class="ui-grid-col-3">
                                                    <label class="field-label resp-label-section">
                                                        <label id="j_idt373" class="ui-outputlabel ui-widget">Permit Upto<font color="#FF0000"> * </font></label>
                                                    </label>
                                                    <span id="j_idt375">
                                                        <input
                                                            id="permit_upto"
                                               ...
                                               <!--  <div class="ui-grid-col-3">
                                                    <label class="field-label resp-label-section">
                                                        <label id="j_idt353" class="ui-outputlabel ui-widget">Insurance Validity<font color="#FF0000"> *</font></label>
                                                    </label>
                                                    <span id="j_idt355">
                                    ...
                                    <div class="ui-grid-row">
                                        <div class="ui-grid-col-3">
                                            <label class="field-label resp-label-section"><label id="j_idt357"
                                                    class="ui-outputlabel ui-widget">District/TRO name:<font
                                                        color="#FF0000"> *</font></label>
                                            </label>
                                            ...
                                            <!-- <select name="border_entry" class="form-control" id="border_entry"> -->
                                                ...
                                                <option value="" selected="selected">---Select distic name--- </option>
                                                    ...
                                                    <option @if($recpt->border_entry=='COIMBATORE WEST') selected="selected" @endif value="COIMBATORE WEST" >COIMBATORE WEST</option>
                                                    <option @if($recpt->border_entry=='GOBICHETTIPALAYAM') selected="selected" @endif value="GOBICHETTIPALAYAM" >GOBICHETTIPALAYAM</option>
                                                    <option @if($recpt->border_entry=='HOSUR') selected="selected" @endif value="HOSUR" >HOSUR</option>
                                                    <option @if($recpt->border_entry=='KRISHNAGIRI') selected="selected" @endif value="KRISHNAGIRI" >KRISHNAGIRI</option>
                                                    <option @if($recpt->border_entry=='MARTHANDAM') selected="selected" @endif value="MARTHANDAM" >MARTHANDAM</option>
                                                    <option @if($recpt->border_entry=='OOTY') selected="selected" @endif value="OOTY" >OOTY</option>
                                                    <option @if($recpt->border_entry=='PETHIKUPPAM') selected="selected" @endif value="PETHIKUPPAM" >PETHIKUPPAM</option>
                                                    <option @if($recpt->border_entry=='POLLACHI') selected="selected" @endif value="POLLACHI" >POLLACHI</option>
                                                    <option @if($recpt->border_entry=='POONAMALLEE') selected="selected" @endif value="POONAMALLEE" >POONAMALLEE</option>
                                                    <option @if($recpt->border_entry=='TENKASI') selected="selected" @endif value="TENKASI" >TENKASI</option>
                                                    <option @if($recpt->border_entry=='THENI') selected="selected" @endif value="THENI" >THENI</option>
                                                    <option @if($recpt->border_entry=='THIRUVALLUR') selected="selected" @endif value="THIRUVALLUR" >THIRUVALLUR</option>
                                                    <option @if($recpt->border_entry=='TINDIVANAM') selected="selected" @endif value="TINDIVANAM">TINDIVANAM</option>
                                                    <option @if($recpt->border_entry=='VELLORE') selected="selected" @endif value="VELLORE">VELLORE</option>
                                                </select>
                                            </div>
                                        </div>
                                        </div>
                                                    ...
                                                    <div id="j_idt363" class="ui-selectonemenu ui-widget ui-state-default ui-corner-all ui-helper-clearfix" style="width: 140px;">
                                                        <div>
                                                            <select name="checkpost_name" class="form-control" id="border_entry">
                                                                ...
                                                                <option @if($recpt->border_entry=='K.G. CHAVADI (IC)') selected="selected" @endif value="K.G. CHAVADI (IC)" >K.G. CHAVADI (IC)</option>
                                                                <option @if($recpt->border_entry=='K.G. CHAVADI (OG)') selected="selected" @endif value="K.G. CHAVADI (OG)" >K.G. CHAVADI (OG)</option>
                                                                <option @if($recpt->border_entry=='BANNARI') selected="selected" @endif value="BANNARI" >BANNARI</option>
                                                                <option @if($recpt->border_entry=='BAGALUR') selected="selected" @endif value="BAGALUR" >BAGALUR</option>
                                                                <option @if($recpt->border_entry=='HOSUR (I/C)') selected="selected" @endif value="HOSUR (I/C)" >HOSUR (I/C)</option>
                                                                <option @if($recpt->border_entry=='HOSUR (O/G)') selected="selected" @endif value="HOSUR (O/G)" >HOSUR (O/G)</option>
                                                                <option @if($recpt->border_entry=='KALIKOVIL') selected="selected" @endif value="KALIKOVIL" >KALIKOVIL</option>
                                                                <option @if($recpt->border_entry=='KALIYAKAVILAI') selected="selected" @endif value="KALIYAKAVILAI" >KALIYAKAVILAI</option>
                                                                <option @if($recpt->border_entry=='GUDALUR') selected="selected" @endif value="GUDALUR" >GUDALUR</option>
                                                                <option @if($recpt->border_entry=='NADUKANI') selected="selected" @endif value="NADUKANI" >NADUKANI</option>
                                                                <option @if($recpt->border_entry=='PETHIKUPPAM') selected="selected" @endif value="PETHIKUPPAM" >PETHIKUPPAM</option>
                                                                <option @if($recpt->border_entry=='GOPALAPURAM') selected="selected" @endif value="GOPALAPURAM" >GOPALAPURAM</option>
                                                                <option @if($recpt->border_entry=='VALANTHAYAMARAM') selected="selected" @endif value="VALANTHAYAMARAM">VALANTHAYAMARAM</option>
                                                                <option @if($recpt->border_entry=='POONAMALLEE') selected="selected" @endif value="POONAMALLEE">POONAMALLEE</option>
                                                                <option @if($recpt->border_entry=='PULIYARAI') selected="selected" @endif value="PULIYARAI">PULIYARAI</option>
                                                                 <option @if($recpt->border_entry=='P.C. PATTI') selected="selected" @endif value="P.C. PATTI">P.C. PATTI</option> 
                                                                 <option @if($recpt->border_entry=='PALAVAKKAM') selected="selected" @endif value="PALAVAKKAM">PALAVAKKAM</option> 
                                                                 <option @if($recpt->border_entry=='TIRUTHANI') selected="selected" @endif value="TIRUTHANI">TIRUTHANI</option> 
                                                                 <option @if($recpt->border_entry=='THIRUCHITRAMBALAM') selected="selected" @endif value="THIRUCHITRAMBALAM">THIRUCHITRAMBALAM</option> 
                                                                 <option @if($recpt->border_entry=='KATPADI') selected="selected" @endif value="KATPADI">KATPADI</option> 
                                                                 <option @if($recpt->border_entry=='SERKADU') selected="selected" @endif value="SERKADU">SERKADU</option>
                                                            ...
                                                            <table role="grid">
                                                                <thead id="qqq_head">
                                                                    <tr role="row">
                                                                        ...
                                                                        <th id="qqq:j_idt395" class="ui-state-default" role="columnheader"><span>Particulars</span></th>
                                            ...
                                            <div class="ui-grid-row">
                                                <div class="ui-grid-col-2">
                                                    <label class="field-label resp-label-section">
                                                        <label id="j_idt404" class="ui-outputlabel ui-widget">Tax Amount<font color="#FF0000"> * </font></label>
                                                    </label>
